# 🐾 PEETS – Plataforma Web de Adoção e Apadrinhamento de Animais
...
- Acessar informações detalhadas sobre cada pet;
- Entrar em contato com a ONG via WhatsApp;
- Realizar apadrinhamento por meio de informações de PIX.
...
- **CodePen** – Desenvolvimento e testes do projeto  
...
- Redirecionamento para formulário de adoção;
- Informações para apadrinhamento via PIX;
...
Posteriormente, o código foi organizado em arquivos separados (`index.html`, `style.css` e `script.js`) e versionado no **GitHub**.
